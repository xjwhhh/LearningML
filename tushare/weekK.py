...
# 获取深证成指，上证指数
a = ts.get_hist_data('sz', start='2017-04-01',ktype='W')  # 一次性获取全部日k线数据
# print(a)
a = a[['p_change']]
...
b = ts.get_hist_data('sh', start='2017-04-01',ktype='W')  # 一次性获取全部日k线数据
# print(a)
b = b[['p_change']]
...
result = ts.get_hist_data('600008', start='2017-04-01',ktype='W')[['p_change']]
...
print(aaaa)
aaaa.to_csv("C:\\Users\\xjwhh\\Desktop\\aa1.csv")
